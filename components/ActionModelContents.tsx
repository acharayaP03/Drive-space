...
export type FileDetailsProps = { file: Models.Document };
...
function ImageThumbnail({ file }: FileDetailsProps) {
    return (
...
function ShareInput({ file, onInputChange, onRemove }: ShareInputProps) {
    return (
        <>
            <ImageThumbnail file={file} />
